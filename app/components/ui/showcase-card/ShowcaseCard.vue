...
<template>
  <div
    ...
    :class="
      cn(
        'relative w-full max-w-full cursor-pointer select-none overflow-hidden bg-neutral-50 ring-1 ring-neutral-200/80 shadow-xl shadow-neutral-300/40 transition-all duration-300 hover:shadow-2xl hover:shadow-neutral-400/30 dark:bg-neutral-950 dark:ring-white/6 dark:shadow-black/40 dark:hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.5)]',
        props.class,
      )
    "
    :style="cardStyle"
